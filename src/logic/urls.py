...
urlpatterns = [
    ...
    path('ativar_conta/', auth_views.ativar_conta, name='ativar_conta'),
    path('efetuar_ativacao/<uidb64>/<token>', auth_views.efetuar_ativacao, name='efetuar_ativacao'),
    path('recuperar_senha/', auth_views.recuperar_senha, name='recuperar_senha'),
    path('redefinir_senha/<uidb64>/<token>', auth_views.redefinir_senha, name='redefinir_senha'),
